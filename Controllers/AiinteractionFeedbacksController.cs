...
namespace Afri.Controllers
{
    public class AiinteractionFeedbacksController : Controller
    {
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public IActionResult SubmitFeedback(int responseId, int rating, string comments) => JsonResult(new { success = false, message = "Feedback submission is currently disabled." });
